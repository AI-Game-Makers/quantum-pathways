...
class Level:
    def __init__(self, screen, tile_size=32):
        ...
        self.tile_images = {
            ...
            'W': pygame.image.load("assets/images/tiles/lime.png"),
            'X': pygame.image.load("assets/images/tiles/light_green.png"),
            'Y': pygame.image.load("assets/images/tiles/sky_blue.png"),
            'Z': pygame.image.load("assets/images/tiles/dark_green.png"),
        }
        self.walls = ['W', 'X', 'Y', 'Z']
        self.quarks = []
